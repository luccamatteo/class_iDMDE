  ...
  if (_scalars_) {
    ...
    if (pba->has_cdm == _TRUE_) {
      ...
      if (ppt->gauge == synchronous) {
        ...
        // For delta_DM:
        if(pba->has_fld == _TRUE_){
          // Implicite assumptions: w_DM = 0, c_{s,DM}^2 = 1, v_T = 0
          if(pba->iDMDE_pert_type == DiValentino){
            // Here we use the equations as they are given in
            //        Eq. (6) of Salvatelli et al. 2013,
            //        Eq. (6) of Di Valentino et al. 2017,
            //        Eq. (4) Di Valentino et al. 2019.
            ...
            //        Eq. (12) of He et al. 2011,
              //      Eq. (12) of Costa et al. 2014 (xi_1=0, delta_Q=3xi_2)
        ...
        if(pba->has_fld == _TRUE_){
          if(pba->iDMDE_pert_type == DiValentino){
            // Here we use the equations as they are given in
            //        Eq. (8) of Salvatelli et al. 2013,
            //        Eq. (8) of Di Valentino et al. 2017
            //        Eq. (5) of Di Valentino et al. 2019
            dy[pv->index_pt_theta_cdm] = - a_prime_over_a*y[pv->index_pt_theta_cdm];
          }
          else if(pba->iDMDE_pert_type == He){
            // Here we use the equations as they are given in
            //        Eq. (14) of Costa et al. 2014 (xi_1=0, delta_Q=3xi_2)
    ...
    if (pba->has_fld == _TRUE_) {
      ...
      if (pba->use_ppf == _FALSE_){
        ...
        // For delta_DE:
        if(pba->has_iDMDE == _TRUE_){
          // Implicite assumptions: c_{s,DE}^2 = 1, c_{a,DE}^2 = w_DE, v_T = 0
          if(pba->iDMDE_pert_type == DiValentino){
            // Here we use the equations as they are given in
            //        Eq. (6) of Di Valentino et al. 2019
            ...
            // Here we use the equations as they are given in
            //        Eq. (13) of Costa et al. 2014 (xi_1=0, delta_Q=3xi_2)
        ...
        if(pba->has_iDMDE == _TRUE_){
          if(pba->iDMDE_pert_type == DiValentino){
            // Here we use the equations as they are given in
            //        Eq. (7) of Di Valentino et al. 2019
            dy[pv->index_pt_theta_fld] = 2*a_prime_over_a*y[pv->index_pt_theta_fld]*(
                                                1.
                                                +pba->delta_Q/(1+w_fld)*(1.
                                                                         -y[pv->index_pt_theta_cdm]/2./y[pv->index_pt_theta_fld])
                                                )
                                        +k2/(1.+w_fld)*y[pv->index_pt_delta_fld];
          }
          else if(pba->iDMDE_pert_type == He){
            // Here we use the equations as they are given in
            //        Eq. (15) of Costa et al. 2014 (xi_1=0, delta_Q=3xi_2)
